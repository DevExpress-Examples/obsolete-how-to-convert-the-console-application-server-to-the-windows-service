    ...
    Friend Class Program
        Shared Sub Main(ByVal args() As String)
            Try
                ...
                logger.LogWriters.Add(New SimpleTextLogWriter(LogLevel.Info, "d:\tmp\appserver.log"))
                ...
                serviceHost.AddServiceEndpoint(GetType(IWcfSecuredDataServer), WcfDataServerHelper.CreateDefaultBinding(), "http://localhost:1451/DataServer2")
                                serviceHost.Open()
